...
$(function(){
  $(".school").click(function(){
    ...
    $.ajax({
          url: "__APP__/School/SchoolGrade",
          type: "POST",
  ...
  $(".monthAddRate").click(function(){
    ...
    $.ajax({
          url: "__APP__/School/MonthAddRate",
          type: "POST",
          data: {schoolId:schoolId},
          dataType: "json",
          error: function(){
  ...
  $(".monthAddNum").click(function(){
    ...
    var schoolName = $(this).attr('id');
    $.ajax({
          url: "__APP__/School/MonthAddNum",
          type: "POST",
          data: {schoolId:schoolId},
          dataType: "json",
          error: function(){
  ...
  $(".schoolMonth").click(function(){
    ...
    var schoolName = $(this).attr('id');  
    $.ajax({
          url: "__APP__/School/SchoolMonthNum",
          type: "POST",
          data: {schoolId:schoolId},
          dataType: "json",
          error: function(){
  ...
  $(".eightWeek").click(function(){
    ...
    var schoolName = $(this).attr('id'); 
    $.ajax({
          url: "__APP__/School/EightWeekData",
          type: "POST",
          data: {schoolId:schoolId},
          dataType: "json",
          error: function(){
  ...
  $(".WeekRate").click(function(){
    ...
    var schoolName = $(this).attr('id'); 
    $.ajax({
          url: "__APP__/School/WeekDataRate",
          type: "POST",
          data: {schoolId:schoolId},
          dataType: "json",
          error: function(){
...
class=right
href="__APP__/School/DoSort?sort=studentDayNumAdd">日增长人数排序</A><A class=right 
 href="__APP__/School/DoSort?sort=WeekData">周增长人数排序</A>
<A class=right 
 href="__APP__/School/DoSort?sort=studentMonthNumAdd">月增长人数排序</A><A 
class=right href="__APP__/School/DoSort?sort=EffStudentNum">有效用户排序</A> <A 
class=right href="__APP__/School/DoSort?sort=studentNum">总人数排序</A> </DIV>
<FORM id=search method='post' action="__APP__/School/Search">
